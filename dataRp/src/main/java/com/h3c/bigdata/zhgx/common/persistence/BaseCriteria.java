...
public class BaseCriteria extends Example.Criteria {
    ...
    public BaseCriteria andCondition(boolean isCondition, String condition, Object value, String typeHandler) {
        if (!isCondition)
            return this;
        return (BaseCriteria)super.andCondition(condition, value, typeHandler);
    }

    public BaseCriteria andCondition(boolean isCondition, String condition, Object value, Class<? extends TypeHandler> typeHandler) {
        if (!isCondition)
            return this;
        return (BaseCriteria)super.andCondition(condition, value, typeHandler);
    }
